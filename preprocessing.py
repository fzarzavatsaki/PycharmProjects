...
def preprocessing(text):
    ...
    for i, doc in enumerate(docs):
        ...
        if doc[0].text != "Feature":
            try:
                ...
                print(f"No features in this project")
            continue
    ...
    for ind, feature in enumerate(features):
        ...
        for doc in feature:
            if doc[0].text == "Scenario":
                nr_of_scenarios += 1
        print(f"Number of Scenarios in Feature {ind}: {nr_of_scenarios}")
            ...
            if doc[0].text == "Scenario":
                ...
                if count >= nr_of_scenarios:
                    ...
                    try:
                        ...
                        print(f"No scenarios in feature{i}")
    ...
    for i, feature in enumerate(list_of_features):
        ...
        #45[]';print("List of Scenarios:", list_of_scenarios)
